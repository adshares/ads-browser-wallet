...
test('parse broadcast', () => {
  ...
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('broadcast');
  expect(parsedData[parser.FIELD.MSG])
    .toBe('00');
  expect(parsedData[parser.FIELD.MSG_LEN])
    .toBe(1);
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.MSID])
    .toBe(1);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536911265 * 1000));
});
...
test('parse change_account_key', () => {
  ...
  const parsedData = parser.parseData(data);
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('change_account_key');
  expect(parsedData[parser.FIELD.PUBLIC_KEY])
    .toBe(
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(5);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531498103 * 1000));
});
...
test('parse change_node_key', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(1);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531495004 * 1000));
});
...
test('parse create_account', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(4);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536923819 * 1000));
});
...
test('parse create_node', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(1);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531496775 * 1000));
});
...
test('parse get_account', () => {
  ...
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('get_account');
  expect(parsedData[parser.FIELD.ADDRESS_DEST])
    .toBe('0001-00000001-8B4E');
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536911902 * 1000));
});
...
test('parse get_accounts', () => {
  ...
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('get_accounts');
  expect(parsedData[parser.FIELD.NODE])
    .toBe('0002');
  expect(parsedData[parser.FIELD.BLOCK_ID])
    .toBe('5B9BA460');
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536926878 * 1000));
});
...
test('parse get_block', () => {
  ...
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536928807 * 1000));
});
...
test('parse get_blocks', () => {
  ...
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('get_blocks');
  expect(parsedData[parser.FIELD.BLOCK_ID_FROM])
    .toBe('5B9BAD20');
  expect(parsedData[parser.FIELD.BLOCK_ID_TO])
    .toBe('00000000');
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536929082 * 1000));
});
...
test('parse get_broadcast', () => {
  ...
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536934767 * 1000));
});
...
test('parse get_log', () => {
  ...
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536935395 * 1000));
});
...
test('parse get_message', () => {
  ...
  expect(parsedData[parser.FIELD.NODE])
    .toBe('0002');
  expect(parsedData[parser.FIELD.NODE_MSID])
    .toBe(73);
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0002-00000001-659C');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531483110 * 1000));
});
...
test('parse get_signatures', () => {
  ...
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536937733 * 1000));
});
...
test('parse get_transaction', () => {
  ...
  const parsedData = parser.parseData(data);
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('get_transaction');
  expect(parsedData[parser.FIELD.TX_ID])
    .toBe('0001:00000007:0002');
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531401106 * 1000));
});
...
test('parse get_vipkeys', () => {
  ...
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('get_vipkeys');
  expect(parsedData[parser.FIELD.VIP_HASH])
    .toBe('2A4831F1459C42E2CCF5C4E202C3301F94C381B6FB253DFED21DD015180D9507');
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1536937358 * 1000));
});
...
test('parse log_account', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(1);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531485913 * 1000));
});
...
test('parse retrieve_funds', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(2);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531495611 * 1000));
});
...
test('parse send_many', () => {
  ...
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('send_many');
  expect(parsedData[parser.FIELD.WIRE_COUNT])
    .toBe(2);

  const wires = parsedData[parser.FIELD.WIRES];
  expect({}.hasOwnProperty.call(wires, '0001-00000001-8B4E'))
    .toBeTruthy();
  expect(wires['0001-00000001-8B4E'])
    .toBe(100 * 100000000000);
  expect({}.hasOwnProperty.call(wires, '0001-00000002-BB2D'))
    .toBeTruthy();
  expect(wires['0001-00000002-BB2D'])
    .toBe(100 * 100000000000);
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.MSID])
    .toBe(4);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1531494505 * 1000));
});
...
test('parse send_one', () => {
  ...
  expect(parsedData[parser.FIELD.ADDRESS_DEST])
    .toBe('0001-00000001-8B4E');
  expect(parsedData[parser.FIELD.AMOUNT])
    .toBe(100000 * 100000000000);
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.MSID])
    .toBe(1);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1533282927 * 1000));
});
...
test('parse set_account_status', () => {
  ...
  const parsedData = parser.parseData(data);
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('set_account_status');
  expect(parsedData[parser.FIELD.ADDRESS_DEST])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.STATUS_ACCOUNT])
    .toBe(2);
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.MSID])
    .toBe(1);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1529393825 * 1000));
});
...
test('parse set_node_status', () => {
  ...
  const parsedData = parser.parseData(data);
  expect(parsedData[parser.FIELD.TYPE])
    .toBe('set_node_status');
  expect(parsedData[parser.FIELD.NODE])
    .toBe('000E');
  expect(parsedData[parser.FIELD.STATUS_NODE])
    .toBe(-2147483648);
  // sender
  expect(parsedData[parser.FIELD.ADDRESS_SRC])
    .toBe('0001-00000000-9B6F');
  expect(parsedData[parser.FIELD.MSID])
    .toBe(121);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1529394308 * 1000));
});
...
test('parse unset_account_status', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(10);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1529393828 * 1000));
});
...
test('parse unset_node_status', () => {
  ...
  expect(parsedData[parser.FIELD.MSID])
    .toBe(37);
  expect(parsedData[parser.FIELD.DATE])
    .toEqual(new Date(1529394375 * 1000));
});
