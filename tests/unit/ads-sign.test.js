...
test('sign empty string', () => {
  ...
  // SG: BB4946AEC4C1BE7E1BCB11B27B3CFB13B3234417FCDC96356CEB910C233423B5
  //     692B93196471C75D1BDB9E8FE2BCAD184E1A0B37976BDF228FF5A60D5173F80B
  ...
  expect(adsSign.sign(data, secretKey))
    .toBe(expSignature);
});
...
test('create private key', () => {
  ...
  expect(adsSign.getSecretKey(seed))
    .toBe(expSecretKey);
});
...
test('create public key', () => {
  ...
  expect(adsSign.getPublicKeyFromSeed(secretKey))
    .toBe(expPublicKey);
});
